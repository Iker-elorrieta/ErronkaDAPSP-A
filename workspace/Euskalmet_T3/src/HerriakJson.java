...
public class HerriakJson {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		 
		String nomArchivo = "herriakJson";
	...
	public static void generarJson(String urlStr, String nomArchivo){
		...
		try {
			...
			FileOutputStream fileOS = new FileOutputStream("src/ArchivosJSON_Herriak/"+nomArchivo+".json"); 
	...
	public static void limpiarJson(String nomArchivo) throws IOException {
		BufferedReader bf = new BufferedReader(new FileReader("src/ArchivosJSON_Herriak/"+nomArchivo+".json",StandardCharsets.UTF_8));
		String texto = "";
        ...
        FileWriter fw = new FileWriter("src/ArchivosJSON_Herriak/"+nomArchivo+".json");
        fw.write(texto);
        fw.close();
	}
	...
	public static void recorrerJson(String nomArchivo) throws IOException {
		...
		try {
			FileReader fr = new FileReader("src/ArchivosJSON_Herriak/"+nomArchivo+".json");
